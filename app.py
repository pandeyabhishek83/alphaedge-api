...
NIFTY_50 = [
    ("HDFCBANK",   "HDFC Bank",           "Banking",     341249),
    ("RELIANCE",   "Reliance",            "Energy",      738561),
    ("ICICIBANK",  "ICICI Bank",          "Banking",     1270529),
    ("INFY",       "Infosys",             "IT",          408065),
    ("TCS",        "TCS",                 "IT",          2953217),
    ("BHARTIARTL", "Bharti Airtel",       "Telecom",     2714625),
    ("SBIN",       "SBI",                 "Banking",     779521),
    ("HINDUNILVR", "HUL",                 "FMCG",        356865),
    ("ITC",        "ITC",                 "FMCG",        424961),
    ("KOTAKBANK",  "Kotak Bank",          "Banking",     492033),
    ("LT",         "L&T",                 "Infra",       2939649),
    ("BAJFINANCE", "Bajaj Finance",       "NBFC",        4268801),
    ("AXISBANK",   "Axis Bank",           "Banking",     1510401),
    ("ASIANPAINT", "Asian Paints",        "FMCG",        60417),
    ("MARUTI",     "Maruti",              "Auto",        2815745),
    ("SUNPHARMA",  "Sun Pharma",          "Pharma",      857857),
    ("TITAN",      "Titan",               "Consumer",    897537),
    ("WIPRO",      "Wipro",               "IT",          969473),
    ("ULTRACEMCO", "UltraTech",           "Cement",      2952193),
    ("NTPC",       "NTPC",                "Power",       2977281),
    ("POWERGRID",  "Power Grid",          "Power",       3834113),
    ("NESTLEIND",  "Nestle India",        "FMCG",        4717569),
    ("TECHM",      "Tech Mahindra",       "IT",          3465729),
    ("M&M",        "M&M",                 "Auto",        519937),
    ("HCLTECH",    "HCL Tech",            "IT",          1850625),
    ("TATAMOTORS", "Tata Motors",         "Auto",        884737),
    ("ONGC",       "ONGC",                "Energy",      633601),
    ("JSWSTEEL",   "JSW Steel",           "Metals",      3001089),
    ("TATASTEEL",  "Tata Steel",          "Metals",      895745),
    ("COALINDIA",  "Coal India",          "Commodities", 5215745),
    ("ADANIENT",   "Adani Enterprises",   "Infra",       6401),
    ("ADANIPORTS", "Adani Ports",         "Infra",       3861249),
    ("CIPLA",      "Cipla",               "Pharma",      177665),
    ("DRREDDY",    "Dr Reddy",            "Pharma",      225537),
    ("BAJAJFINSV", "Bajaj Finserv",       "NBFC",        4268033),
    ("GRASIM",     "Grasim",              "Cement",      315393),
    ("EICHERMOT",  "Eicher Motors",       "Auto",        232961),
    ("HEROMOTOCO", "Hero MotoCorp",       "Auto",        345089),
    ("APOLLOHOSP", "Apollo Hospitals",    "Healthcare",  157513),
    ("BPCL",       "BPCL",                "Energy",      134657),
    ("TATACONSUM", "Tata Consumer",       "FMCG",        878593),
    ("HINDALCO",   "Hindalco",            "Metals",      348929),
    ("DIVISLAB",   "Divis Labs",          "Pharma",      2800641),
    ("BRITANNIA",  "Britannia",           "FMCG",        140033),
    ("BAJAJ-AUTO", "Bajaj Auto",          "Auto",        4267265),
    ("SHREECEM",   "Shree Cement",        "Cement",      3506433),
    ("SBILIFE",    "SBI Life",            "Insurance",   5582849),
    ("HDFCLIFE",   "HDFC Life",           "Insurance",   119553),
    ("INDUSINDBK", "IndusInd Bank",       "Banking",     1346049),
    ("LTIM",       "LTIMindtree",         "IT",          4752385),
]

NIFTY_NEXT_50 = [
    ("ADANIGREEN", "Adani Green",         "Power",       2381825),
    ("AMBUJACEM",  "Ambuja Cements",      "Cement",      1152769),
    ("AUROPHARMA", "Aurobindo Pharma",    "Pharma",      67329),
    ("BANDHANBNK", "Bandhan Bank",        "Banking",     579329),
    ("BANKBARODA", "Bank of Baroda",      "Banking",     1195009),
    ("BEL",        "BEL",                 "Defence",     144384),
    ("BERGEPAINT", "Berger Paints",       "FMCG",        1893633),
    ("BOSCHLTD",   "Bosch",               "Auto",        2865921),
    ("CANBK",      "Canara Bank",         "Banking",     2763265),
    ("CHOLAFIN",   "Chola Finance",       "NBFC",        175361),
    ("COLPAL",     "Colgate",             "FMCG",        1082113),
    ("DABUR",      "Dabur",               "FMCG",        197633),
    ("DLF",        "DLF",                 "Realty",      3771393),
    ("FEDERALBNK", "Federal Bank",        "Banking",     261889),
    ("GAIL",       "GAIL",                "Energy",      1207553),
    ("GODREJCP",   "Godrej Consumer",     "FMCG",        2513921),
    ("HAL",        "HAL",                 "Defence",     2513665),
    ("HAVELLS",    "Havells",             "Consumer",    2513793),
    ("ICICIGI",    "ICICI Lombard",       "Insurance",   4270337),
    ("ICICIPRULI", "ICICI Pru Life",      "Insurance",   4268289),
    ("INDHOTEL",   "Indian Hotels",       "Consumer",    371201),
    ("INDUSTOWER", "Indus Towers",        "Telecom",     3691009),
    ("IOC",        "IOC",                 "Energy",      415745),
    ("IRCTC",      "IRCTC",               "Consumer",    3484417),
    ("JINDALSTEL", "Jindal Steel",        "Metals",      3001345),
    ("LICI",       "LIC India",           "Insurance",   4633857),
    ("LUPIN",      "Lupin",               "Pharma",      2672641),
    ("MUTHOOTFIN", "Muthoot Finance",     "NBFC",        3400961),
    ("NAUKRI",     "Info Edge",           "Tech",        3788033),
    ("NMDC",       "NMDC",                "Metals",      3924993),
    ("OFSS",       "Oracle Fin",          "IT",          621569),
    ("PERSISTENT", "Persistent",          "IT",          4701441),
    ("PIDILITIND", "Pidilite",            "Chemicals",   3689217),
    ("PNB",        "PNB",                 "Banking",     3930369),
    ("RECLTD",     "REC",                 "NBFC",        3238913),
    ("SBICARD",    "SBI Card",            "NBFC",        5003265),
    ("SIEMENS",    "Siemens",             "Infra",       806401),
    ("SRF",        "SRF",                 "Chemicals",   3463681),
    ("TORNTPHARM", "Torrent Pharma",      "Pharma",      3771137),
    ("TRENT",      "Trent",               "Retail",      1459457),
    ("TVSMOTOR",   "TVS Motor",           "Auto",        2170625),
    ("VEDL",       "Vedanta",             "Metals",      784129),
    ("ZOMATO",     "Zomato",              "Tech",        5215745),
    ("ZYDUSLIFE",  "Zydus Life",          "Pharma",      4915457),
    ("TATAPOWER",  "Tata Power",          "Power",       877057),
    ("BIOCON",     "Biocon",              "Pharma",      2911489),
    ("MCDOWELL-N", "United Spirits",      "FMCG",        3932929),
    ("PEL",        "Piramal",             "NBFC",        3698945),
    ("UBL",        "United Breweries",    "FMCG",        4278017),
]

# Combined deduplicated universe
_seen = set()
STOCKS = []
for entry in NIFTY_50 + NIFTY_NEXT_50:
    if entry[0] not in _seen:
        _seen.add(entry[0])
        STOCKS.append(entry)

# Kite token map built from STOCKS
KITE_TOKENS = {s[0]: s[3] for s in STOCKS}
...
# KITE_TOKENS now built from STOCKS list above

def fetch(sym):
    """
    Fetch historical OHLCV data for a stock.
    Uses Kite Connect if authenticated (real-time),
    falls back to Yahoo Finance otherwise.
    """

    # ── Try Kite first ──────────────────────────────────────────
    if kite_access_token and sym in KITE_TOKENS:
        try:
            kite.set_access_token(kite_access_token)
            ...
            from_date = to_date - pd.Timedelta(days=90)
...
def get_market():
    """
    Get Nifty 50 market context.
    Uses Kite Connect (real-time) if authenticated,
    falls back to Yahoo Finance otherwise.
    """

    # ── Try Kite first (real data) ──────────────────────────────
    if kite_access_token:
        try:
            ...
            if not candles or len(candles) < 20:
                raise Exception("Insufficient Kite candle data")
            ...
            # Session price reference as VWAP proxy
            # (Nifty index candles have zero volume)
            typical = (
            ...
            vwap_proxy = sum(recent_typical) / len(recent_typical)

            av20    = price > ema20
            av_vwap = price > vwap_proxy

            # Breadth: last 3 closes trending up
            last3  = [float(c["close"]) for c in candles[-3:]]
            bread  = bool(last3[-1] > last3[0])
            ...
            return {
                ...
                "block_long":   bear >= 2,
                "block_short":  bull >= 3,
                "last_candle":  str(last_candle.get("date", ""))
            }

        except Exception as e:
            # Kite failed — fall through to Yahoo
            pass
    ...
    try:
        ...
        for ticker in ["^NSEI", "NIFTY50.NS", "^CNX500"]:
            try:
                t = yf.Ticker(ticker)
        ...
        bull   = sum([chg>0.5, av20, rsi>55, av_vwap])
        bias   = (
            "STRONGLY BEARISH" if bear>=3 else "BEARISH" if bear==2 else
            "STRONGLY BULLISH" if bull>=3 else "BULLISH" if bull==2 else "NEUTRAL"
        )
...
def scan():
    ...
    # Default to a larger slice of the expanded Nifty 50 + Next 50 universe
    n = min(
        int(request.args.get("n", 40)),
        len(STOCKS)
    )
    ...
    if (
        ...
        for entry in batch:
            sym, name, sector = entry[0], entry[1], entry[2]
    ...
    if len(gated) == 0:
        if not mkt.get("available", False):
            note = "Market data unavailable — NO TRADE"
        elif mkt.get("block_long") and mkt.get("block_short"):
            note = "Market conditions block both long and short — Sit on hands"
        elif mkt.get("block_long"):
            note = "Market blocks LONG setups today"
        elif mkt.get("block_short"):
            note = "Market blocks SHORT setups today"
        else:
            note = "No stocks met the AlphaEdge score + filter criteria today. Sit on hands."
...
def debug_market():
    """Debug endpoint to diagnose market data failures."""
    results = {}

    # Test 1: Kite connection
    results["kite_token_present"] = bool(kite_access_token)
    results["kite_configured"] = bool(KITE_API_KEY)

    # Test 2: Kite candle fetch
    if kite_access_token:
        try:
            kite.set_access_token(kite_access_token)
            to_date = datetime.now()
            from_date = to_date - pd.Timedelta(days=5)
            candles = kite.historical_data(
                256265, from_date, to_date,
                "5minute", continuous=False, oi=False
            )
            results["kite_candles_count"] = len(candles) if candles else 0
            results["kite_last_candle"] = str(candles[-1]) if candles else None
            results["kite_error"] = None
        except Exception as e:
            results["kite_candles_count"] = 0
            results["kite_error"] = str(e)
    else:
        results["kite_error"] = "No access token"
    ...
    for ticker in ["^NSEI", "NIFTY50.NS", "^CNX500"]:
        try:
            ...
            results[f"yahoo_{ticker}"] = {
                "rows": len(h),
                "empty": h.empty,
                "last": str(h["Close"].iloc[-1]) if not h.empty else None
            }
        except Exception as e:
            results[f"yahoo_{ticker}"] = {"error": str(e)}
